...
export const PRESET_ACTIVITIES: PresetActivity[] = [
  { id: 'fb_chat', name: 'Reply chat customer on Facebook page', category: 'Support', colorClass: 'bg-blue-50 text-blue-700 border-blue-200 hover:bg-blue-100' },
  { id: 'check_platform', name: 'Check platform', category: 'Operations', colorClass: 'bg-emerald-50 text-emerald-700 border-emerald-200 hover:bg-emerald-100' },
  ...
  { id: 'design_poster', name: 'Design poster', category: 'Design', colorClass: 'bg-purple-50 text-purple-700 border-purple-200 hover:bg-purple-100' },
  { id: 'edit_video', name: 'Edit video', category: 'Video', colorClass: 'bg-indigo-50 text-indigo-700 border-indigo-200 hover:bg-indigo-100' },
  { id: 'post_page', name: 'Post page', category: 'Marketing', colorClass: 'bg-rose-50 text-rose-700 border-rose-200 hover:bg-rose-100' },
  { id: 'find_element', name: 'Find element for design', category: 'Design', colorClass: 'bg-cyan-50 text-cyan-700 border-cyan-200 hover:bg-cyan-100' },
...
export interface ScheduleTask {
  ...
  taskName: string; // e.g. "Check platform" or "Reply chat customer on Facebook page"
